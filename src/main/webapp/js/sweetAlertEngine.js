...
! function(e, t) {
    ...
    const kn = ["swal-title", "swal-html", "swal-footer"],
        ...
        jn = e => {
            ...
            })()), V() || o.previousActiveElement || (o.previousActiveElement = document.activeElement), "function" == typeof e.didOpen && setTimeout(() => e.didOpen(n)), o.eventEmitter.emit("didOpen", n)
        },
        Hn = e => {
            const t = C();
    ...
    }), Un.DismissReason = ze, Un.version = "11.26.3";
    const Qn = Un;
