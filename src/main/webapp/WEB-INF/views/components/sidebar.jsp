...
<!-- 🧭 SIDEBAR ESCRITORIO (tu sidebar original) -->
<div class="col-md-3 col-lg-2 d-none d-md-block sidebar collapse p-0">
...
<!-- 📱 SIDEBAR MÓVIL (MISMO CÓDIGO REUTILIZADO COMO OFFCANVAS) -->
<div class="offcanvas offcanvas-start d-md-none sidebar" tabindex="-1" id="sidebarMobile">
