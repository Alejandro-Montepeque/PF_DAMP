...
public class Lector implements Serializable {
    ...
    public Lector(Integer idBibliotecario) {
        this.idBibliotecario = idBibliotecario;
    }

    public Lector(Integer idBibliotecario, Date fechaIngreso) {
        this.idBibliotecario = idBibliotecario;
    ...
    public String toString() {
        return "com.biblioteca.sistema_gerencial_para_biblioteca.model.Lector[ idBibliotecario=" + idBibliotecario + " ]";
    }
